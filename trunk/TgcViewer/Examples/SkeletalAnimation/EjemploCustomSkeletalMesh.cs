...
namespace Examples.SkeletalAnimation
{
    ...
    public class MyCustomMesh : TgcSkeletalMesh
    {
        ...
        /// </summary>
        public MyCustomMesh(Mesh mesh, string name, MeshRenderType renderType, OriginalData origData, TgcSkeletalBone[] bones, TgcSkeletalVertexWeight[] verticesWeights)
            : base(mesh, name, renderType, origData, bones, verticesWeights)
        {
        }
    ...
    public class MyCustomMeshFactory : TgcSkeletalLoader.IMeshFactory
    {
        ...
        {
            return new MyCustomMesh(d3dMesh, meshName, renderType, origData, bones, verticesWeights);
        }
    }
